   ...
   <div class="container py-4">
      ...
      %>
         <div class="row align-items-md-stretch">
            <div class="col-md-5">
               <img alt="책이름" src="./resources/images/<%=rs.getString("b_fileName")%>" style="width:100%;">
            </div>
            
            <form action="./processUpdateBook.jsp" method="post" enctype="multipart/form-data" name="newBook">
               <div class="mb-3 row">
               ...
               <div class="mb-3 row">
                  ...
                  <div class="col-sm-5">
                     <textarea name="description" id="description" class="form-control" cols="50" rows="5" placeholder="1자 이상 적어주세요.">
